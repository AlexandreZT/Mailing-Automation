...
params = {
    'imap_ssl_host':    'ssl0.ovh.net', #imap.gmail.com
    'imap_ssl_port':    993,
    'username':         'formation@novolinko.com', # documentio.novolinko@gmail.com
    'password':         'F4ut31lS0l31l!', # D0cum3nt10!
    'criteria':         {
                            # 'FROM': 'steve.lucas@gmail.com',
                            # 'SUBJECT': 'run_test_new_opportunity_from_powerpoint_page_in_novolinko'
                        },
    'uid_max':          0,
    'folder':           'Tracking',
    'start_date':       'SINCE 27-Feb-2020',
    'end_date':         'BEFORE 27-Jun-2020'
}
